...
public class CharA1Activity extends Activity implements OnChartValueSelectedListener, DynamicTitleBar.OnClickTitleBarListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chartt5_activity);
