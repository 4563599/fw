...
public class Char4Activity extends BaseActivity implements OnProgressBarListener {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        tv_title.setText("降雨量数据");
        tv_progress.setText("降雨量数据正在加载中....");
        tv_sd.setText("降雨量 1");
    }
        ...
        subscription2 = Observable.interval(100, TimeUnit.MILLISECONDS)
                ...
                .subscribe(new Observer<Long>() {
                    ...
                    public void onNext(Long aLong) {
                        ...
                        if (values.size() < 10) {
                            bnp.incrementProgressBy(1);
                            values.add(new Entry(j, Float.parseFloat(mSimpleDatasBean.getData().get(i).getRainfall())));
                            total += Float.parseFloat(mSimpleDatasBean.getData().get(i).getRainfall());
                            ...
                            tv_now_pres.setText(mSimpleDatasBean.getData().get(i).getRainfall());
                            int max = 100;
                            int min = 30;
                        ...
                        set = new LineDataSet(values, "降雨量1");
                        ...
                        y3.setAxisMinimum(0.0f);
                        y3.setAxisMaximum(1.0f);
                        chart.invalidate();
                        i++;
                        j++;
                        Log.i("lyy08", "i:" + i);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_1:
                ...
                break;
            case R.id.menu_2:
                Intent intent2 = new Intent(this, Char4Activity.class);
