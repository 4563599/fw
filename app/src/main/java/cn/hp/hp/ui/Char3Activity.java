...
public class Char3Activity extends BaseActivity implements OnProgressBarListener {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        tv_title.setText("空隙压数据");
        tv_progress.setText("空隙压数据正在加载中....");
        tv_sd.setText("空隙压 1");
    }
        ...
        subscription2 = Observable.interval(100, TimeUnit.MILLISECONDS)
                ...
                .subscribe(new Observer<Long>() {
                    ...
                    public void onNext(Long aLong) {
                        ...
                        if (values.size() < 10) {
                            bnp.incrementProgressBy(1);
                            values.add(new Entry(j, Float.parseFloat(mSimpleDatasBean.getData().get(i).getPressure1())));
                            total += Float.parseFloat(mSimpleDatasBean.getData().get(i).getPressure1());
                            ...
                            tv_now_pres.setText(mSimpleDatasBean.getData().get(i).getPressure1());
                            int max = 100;
                            int min = 30;
                        ...
                        set = new LineDataSet(values, "空隙压");
                        ...
                        y3.setAxisMinimum(-10.0f);
                        y3.setAxisMaximum(10.0f);
                        chart.invalidate();
                        i++;
                        j++;
                        Log.i("lyy08", "i:" + i);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_1:
                ...
                break;
            case R.id.menu_2:
                Intent intent2 = new Intent(this, Char3Activity.class);
