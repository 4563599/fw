...
import com.hp.hp.R;
import cn.hp.hp.http.ApiFactory;
import cn.hp.hp.http.BaseWeatherResponse;
import cn.hp.hp.model.AqiDetailBean;
import cn.hp.hp.model.FakeWeather;
import cn.hp.hp.model.HeWeather;
import cn.hp.hp.model.HeWeatherAir;
import cn.hp.hp.model.IFakeWeather;
import cn.hp.hp.model.WeatherCity;
import cn.hp.hp.ui.Char1Activity;
import cn.hp.hp.ui.Char2Activity;
import cn.hp.hp.ui.Char3Activity;
...
import cn.hp.hp.ui.CharRainfallActivity;
import cn.hp.hp.ui.CharT1Activity;
import cn.hp.hp.ui.ImagesActivity;
import cn.hp.hp.ui.base.BaseContentFragment;
import cn.hp.hp.ui.weather.adapter.AqiAdapter;
import cn.hp.hp.ui.weather.adapter.HourlyAdapter;
import cn.hp.hp.ui.weather.adapter.SuggestionAdapter;
import cn.hp.hp.ui.weather.dynamic.BaseWeatherType;
import cn.hp.hp.ui.weather.dynamic.DynamicWeatherView;
import cn.hp.hp.ui.weather.dynamic.ShortWeatherInfo;
import cn.hp.hp.ui.weather.dynamic.TypeUtil;
import cn.hp.hp.utils.ACache;
import cn.hp.hp.utils.SettingsUtil;
import cn.hp.hp.utils.ThemeUtil;
import cn.hp.hp.utils.WeatherUtil;
import cn.hp.hp.widgets.AqiView;
import cn.hp.hp.widgets.WeatherChartView;
...
public class CityWeatherFragment extends BaseContentFragment implements NestedScrollView.OnScrollChangeListener {
    ...
    private String cityId = "兰州";

    private String cityName = "兰州";
    ...
    protected void initViews() {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), CharT1Activity.class);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), CharH1Activity.class);
                startActivity(intent);
            }
        });
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), CharPressure1Activity.class);
                startActivity(intent);
            }
        });
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), CharRainfallActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), CharA1Activity.class);
                startActivity(intent);
            }
        });
