...
public class Char8Activity extends Activity implements OnChartValueSelectedListener, DynamicTitleBar.OnClickTitleBarListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chartt8_activity);
...
//            set1.enableDashedLine(10f, 5f, 0f);
    ...
    private void getDataFromNet(int hour) {
        RetrofitUtil.getInstance().getDataService().get_displacement1_mean(hour).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Observer<T1Bean>() {
            @Override
