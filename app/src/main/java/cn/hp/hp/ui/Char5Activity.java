...
public class Char5Activity extends BaseActivity implements OnProgressBarListener {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        tv_title.setText("湿度数据");
        tv_progress.setText("湿度数据正在加载中....");
        tv_sd.setText("湿度 1");
    }
        ...
        subscription2 = Observable.interval(100, TimeUnit.MILLISECONDS)
                ...
                .subscribe(new Observer<Long>() {
                    ...
                    public void onNext(Long aLong) {
                        ...
                        if (values.size() < 10) {
                            bnp.incrementProgressBy(1);
                            values.add(new Entry(j, Float.parseFloat(mSimpleDatasBean.getData().get(i).getHumidity1())));
                            total += Float.parseFloat(mSimpleDatasBean.getData().get(i).getHumidity1());
                            ...
                            tv_now_pres.setText(mSimpleDatasBean.getData().get(i).getHumidity1());
                            int max = 100;
                            int min = 30;
                        ...
                        set = new LineDataSet(values, "湿度1");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_1:
                ...
                break;
            case R.id.menu_2:
                Intent intent2 = new Intent(this, Char5Activity.class);
