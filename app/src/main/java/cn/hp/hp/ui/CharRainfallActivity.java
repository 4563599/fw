...
public class CharRainfallActivity extends Activity implements OnChartValueSelectedListener, DynamicTitleBar.OnClickTitleBarListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chartt4_activity);
