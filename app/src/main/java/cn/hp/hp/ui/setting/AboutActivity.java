...
public class AboutActivity extends BaseActivity {
    ...
    private void feedBack() {
        ...
        intent.putExtra(Intent.EXTRA_TEXT, FileUtil.readFile(FileUtil.getFileDir("Log/crash.log")));
