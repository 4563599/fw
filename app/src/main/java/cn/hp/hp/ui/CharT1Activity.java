...
public class CharT1Activity extends Activity implements OnChartValueSelectedListener, DynamicTitleBar.OnClickTitleBarListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chartt1_activity);
    ...
    private void initChart(T1Bean t1Bean) {
        ...
        float max = Math.round(Float.parseFloat(t1Bean.getBaseNumData().getMax()) + 1);
        float min = Math.round(Float.parseFloat(t1Bean.getBaseNumData().getMin()) - 1);
